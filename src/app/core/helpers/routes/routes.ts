...
export class routes {
  ...
  public static get dashboard_page(): string {
    return this.baseUrl + '/dashboard/admin';
  }
  public static get holidays(): string {
    return this.baseUrl + '/employees/holidays';
  }
  public static get massage(): string {
    return this.baseUrl + '/employees/message';
  }
  ...
  public static get teamspage(): string {
    return this.baseUrl + '/teams/teams-content';
  }
  public static get taskpage(): string {
    return this.baseUrl + '/taches/taches-content';
  }
  public static get salairepage(): string {
    return this.baseUrl + '/salaire/salaire-page';
  }
  public static get absencepage(): string {
    return this.baseUrl + '/absences/absences-page';
  }
  public static get docpage(): string {
    return this.baseUrl + '/documents/document-page';
  }
  public static get docreq(): string {
    return this.baseUrl + '/documents/request-page';
  }
  public static get demandeabsencepage(): string {
    return this.baseUrl + '/absences/request-page';
  }
  public static get salaireall(): string {
    return this.baseUrl + '/salaire/all-salaire';
  }
  public static get demandesalairepage(): string {
    return this.baseUrl + '/salaire/demande-page';
  }
  public static get documentspage(): string {
    return this.baseUrl + '/documents/document-page';
  }
  ...
  public static get assets(): string {
    return this.baseUrl + '/assets/mains';
  }
